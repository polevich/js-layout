...
const POST_LIST = [
  {
    ...
    info: 'К черту планировщик, нанимаем дизайнера и готовимся к презентации, как Джобс',
    date: '25.01',
    viewed: false,
  },
  {
    category: [{ text: 'Новое', id: 2 }],
    info: 'Мы хотели чтобы в этом чате было около 150 человек чтобы сделать качественный пакет самопрезентаций.',
    date: '24.01',
    viewed: true,
  },
]
